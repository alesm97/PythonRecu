...
funcionesMenuVoluntarios = ("menuColaboradores", "menuVeterinariosCol", "menuPrincipal")
funcionesMenuColaboradores = ("listarColaboradores", "agregarColaboradores", "eliminarColaboradores", "menuVoluntarios")
funcionesMenuVetCol = ("listarVetCol", "agregarVetCol", "eliminarVetCol", "menuVoluntarios")
funcionesMenuTrabajos = ("listarTrabajosCol", "listarTrabajosVet", "agregarTrabajo", "menuPrincipal")
